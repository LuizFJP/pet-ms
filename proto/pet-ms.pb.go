...
func (x *UpdatePetRequest) GetSpecie() string {
	if x != nil {
		return x.Specie
	}
	return ""
...
func (x *DeletePetRequest) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
func (x *GetPetRequest) GetUuidGuardian() string {
	if x != nil {
		return x.UuidGuardian
	}
	return ""
...
const file_proto_pet_ms_proto_rawDesc = "" +
	...
	"birth_year\x18\x05 \x01(\x04R\tbirthYear\x12\x14\n" +
	"\x05breed\x18\x06 \x01(\tR\x05breed\x12\x16\n" +
	"\x06specie\x18\a \x01(\tR\x06specie\"\xd8\x01\n" +
